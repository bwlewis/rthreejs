...
plate carrée equirectangular projection maps, also known as lat/long maps.
...
will work with other R packages like Andy South's excellent new *rworldmap* package.
