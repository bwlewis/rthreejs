...
The new `grapjhs` function (an [html widget](http://htmlwidgets.org) and part
of the [threejs](http://bwlewis.github.io/rthreejs) package), makes it easy to
plot interactive 3-d graphs.
