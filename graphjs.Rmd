...
can be interpreted as a measure connectivity between nodes. That is,
...
The `igraph` package defines a comprehensive interface to the superb
[igraph](http://igraph.org/redirect.html) network analysis library.
Use `graphjs` directly on igraph graph objects.
