...
```
Let's take a quick look at this list to help see what we've defined:
```{r}
str(click)
```
...
<br/>
<a href="vertex.html">Click here to proceed to an animation example that accumulates expanded vertex positions.</a>
